...
const actions: JourneyAction[] = [
  ...
  // ── Passo 4a: Registrar Value Schema (VS) via carrinho ──────────────────────
  {
    ...
    title: "Adicionar VS ao carrinho (registrar schema)",
    app: "Business",
    ...
    requiresM2M: true,
    requiresUser: "employee",
    description: "Adiciona o Value Schema ao carrinho com itemType 'vs-registration-annual'. Este é o primeiro checkout — registra o schema na plataforma.",
  ...
  },
  {
    ...
    title: "Checkout — registrar Value Schema (cria produto no catálogo)",
    app: "Business",
    group: "Registro de Produto",
    method: "POST",
    status: "external",
  ...
  // ── Passo 4b: Consultar dSKUs, adicionar ao carrinho e registrar produto ──
  {
    ...
    title: "Consultar catálogo de dSKUs",
    app: "Business",
    group: "Registro de Produto",
    method: "GET",
  ...
  },
  {
    ...
    title: "Adicionar dSKU ao carrinho (registrar produto)",
    app: "Business",
    group: "Registro de Produto",
    method: "POST",
    status: "external",
    requiresM2M: true,
    requiresUser: "employee",
    description: "Adiciona o dSKU selecionado ao carrinho com itemType 'dsku-registration-annual'.",
    buildPath: state => `/v1/marketplace/cart/${encodeURIComponent(String(state.businessDwalletId || state.businessId || ""))}/add`,
    buildBody: state => ({
  ...
  },
  {
    ...
    title: "Checkout — registrar produto na BdW (cria produto final)",
    app: "Business",
    group: "Registro de Produto",
    method: "POST",
    status: "external",
  ...
  },
  {
    ...
    title: "Confirmar: listar produtos registrados na BdW",
    app: "Business",
    group: "Registro de Produto",
    method: "GET",
    status: "external",
  ...
  },
  {
    ...
    requiresM2M: true,
    requiresUser: "person",
    description: "Certificados de dados: API existe mas sandbox não tem dados. Mala no Slack: 'we do not expose data certificates for wallets anywhere in the platform — functionality is still roadmap/future work. DValue/DUC through Wallet APIs + cash balance was sufficient.' O endpoint retorna 200 com lista vazia.",
    expectedStatus: [200, 201, 204, 400, 500],
  },
  {
    ...
    requiresM2M: true,
    requiresUser: "employee",
    description: "Certificados Business: conforme Slack, certificados não são expostos externamente ainda. É roadmap futuro. Sandbox retorna lista vazia ou erro de permissão.",
    expectedStatus: [200, 201, 204, 400, 500],
  },
  {
  ...
  // ── Step 11: Create Offer (preview + purchase) ──────────────────────────────
  {
    ...
    method: "POST",
    path: "/v1/offers/preview",
    status: "external",
    requiresM2M: true,
    requiresUser: "employee",
    baseUrlOverride: "https://offers-service.k8s.int.dev.drumwave.com",
    description: "Gera preview de oferta. Usa offers-service.k8s.int.dev.drumwave.com conforme confirmado no Slack (Mala/Meena).",
  ...
  // ── Step 12: View Offer Transactions ─────────────────────────────────────────
  {
    ...
    title: "Listar ofertas disponíveis",
    app: "Personal",
    group: "Marketplace Offers",
    method: "GET",
    path: "/v1/offers",
    ...
    requiresUser: "person",
    baseUrlOverride: "https://offers-service.k8s.int.dev.drumwave.com",
    description: "Lista todas as ofertas disponíveis para a pessoa física. Usa offers-service conforme Slack.",
  ...
  },
  {
    ...
    requiresUser: "person",
    baseUrlOverride: "https://offers-service.k8s.int.dev.drumwave.com",
    description: "Lista as transações associadas a uma oferta específica. Usa offers-service conforme Slack (Meena: 'Offers (transactions list) — https://offers-service.k8s.int.dev.drumwave.com/v1/docs').",
    expectedStatus: [200, 201, 204, 403, 404, 500],
    buildPath: state => `/v1/offers/${state.offerId || ""}/transactions`,
    onSuccess: (body) => {
  ...
  },
  {
    ...
    title: "Pessoa pré-aceita oferta (opcional)",
    app: "Personal",
    group: "Marketplace Offers",
    method: "POST",
    status: "external",
    ...
    requiresUser: "person",
    baseUrlOverride: "https://offers-service.k8s.int.dev.drumwave.com",
    description: "Pré-aceite da oferta (step 13a do Postman). Opcional — informa o e-mail antes do aceite definitivo.",
    expectedStatus: [200, 201, 204, 400, 500],
    buildPath: state => `/v1/offers/${state.offerId}/pre-accept`,
  ...
  },
  {
    ...
    requiresUser: "person",
    baseUrlOverride: "https://offers-service.k8s.int.dev.drumwave.com",
    description: "Aceite de oferta. Body: emailAddress + dataSavingsAccountId (obrigatórios conforme Postman). Usa offers-service.",
    expectedStatus: [200, 201, 204, 400, 500],
    buildPath: state => `/v1/offers/${state.offerId}/accept`,
    buildBody: state => ({
  ...
  },
  {
    ...
    requiresUser: "person",
    baseUrlOverride: "https://offers-service.k8s.int.dev.drumwave.com",
    description: "Rejeita a oferta. Body: emailAddress do Postman (step 13c).",
    expectedStatus: [200, 201, 204, 400, 500],
    buildPath: state => `/v1/offers/${state.offerId}/reject`,
    buildBody: state => ({ emailAddress: state.personEmail }),
  },
  // ── Step 14: DSA Balance ──────────────────────────────────────────────────────
  {
    ...
    requiresM2M: true,
    requiresUser: "person",
    baseUrlOverride: "https://dsp-api.k8s.int.dev.drumwave.com",
    description: "Consulta saldo DSA. Usa dsp-api.k8s.int.dev.drumwave.com conforme Slack (Meena: 'DSP (total balance) — https://dsp-api.k8s.int.dev.drumwave.com').",
    expectedStatus: [200, 201, 204, 404, 500],
...
const steps: JourneyStep[] = [
  ...
  { id: 12, title: "Visualizar Ofertas e Transações", app: "Personal", summary: "Lista ofertas disponíveis (offers-service) e transações de uma oferta específica via offerId.", status: "external", actions: actions.filter(a => a.id === "step12_list_offers" || a.id === "step12_offer_transactions") },
