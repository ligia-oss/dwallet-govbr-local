...
const steps: JourneyStep[] = [
  ...
  { id: 4, title: "Empresa consulta/cadastra produtos", app: "Business", summary: "Catálogo executável; criação e gestão não são tratadas como ausência da API de consulta.", status: "external", actions: actions.filter(a => a.id === "step4_list_products") },
