      ...
      <div className="container space-y-8 py-8">
        ...
        <section className="grid gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <h3 className="font-bold text-slate-950">Credenciais guarda respostas úteis</h3>
            <p className="text-sm leading-6 text-slate-600">A aba reúne valores retornados por API, com data, origem e finalidade provável de reutilização.</p>
          </div>
        </section>
      </div>
    </main>
